...
grep -h '^JNIEXPORT .* Java_' /home/nmld/Downloads/avexe-g5-jamvm/classpath-0.98/include/*.h | \
...
find /home/nmld/Downloads/avexe-g5-jamvm/classpath-0.98/native/jni -name \*.c | \
	xargs grep -h '^Java_' | \
...
find /home/nmld/Downloads/avexe-g5-jamvm/classpath-0.98/native/jni -name \*.cpp | \
	xargs grep -h '^Java_' | \
        LC_ALL=C sed -e 's,^\(Java_[a-z_A-Z0-9]*\).*$,\1,' >> $TMPFILE2
find /home/nmld/Downloads/avexe-g5-jamvm/classpath-0.98/native/jni -name \*.cpp | \
