...
/**
 * Tests concurrent writes and reads to shared private normal fields.
 */
public class TestAll{
	...
	public static void testShort() throws Exception {
		ShortHolder holder = new ShortHolder((short)0);
	...
	public static void testRef() throws Exception {
		RefHolder holder = new RefHolder(new Integer(0));
